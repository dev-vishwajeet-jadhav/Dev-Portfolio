        ...
        >
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              required
              rows={4}
              className="w-full rounded-lg border border-border-subtle/80 bg-surface px-3 py-2 text-sm outline-none ring-offset-background focus-visible:ring-focus-visible resize-none"
            />
          </div>
